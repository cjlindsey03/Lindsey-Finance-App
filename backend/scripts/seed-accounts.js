...
const RECURRING_BILLS = [
  ...
  { id: 'storage_unit', desc: 'Storage unit', category: 'Other', amount: -95, day: 1, type: 'bill' },
  ...
  { id: 'ally_payment', desc: 'Ally auto payment', category: 'Car_Payment', amount: -334.82, day: 19, type: 'bill' },
  { id: 'exeter_payment', desc: 'Exeter auto payment', category: 'Car_Payment', amount: -367.73, day: 26, type: 'bill' },
...
const STARTER_PLAN = {
  ...
  label: 'Sep 15 Plan',
  income: 2098.84,
  allocations: { Phone: 346, Childcare: 300, Debt_Payment: 461.39, Car_Payment: 702.55 },
  g1Extra: 0,
  g2Allocation: 250,
